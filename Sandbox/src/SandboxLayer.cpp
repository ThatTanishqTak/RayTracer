...
void SandboxLayer::OnImGuiRender()
{
    ...
    // Only query GPU metrics when the renderer operates in GPU mode.
    if (m_Renderer.GetRenderMode() == Engine::Renderer::RenderMode::RayTraceGPU)
    {
        ...
        // TODO: Add GPU utilization percentage and other GPU metrics.
    }
#endif
    ImGui::End();
